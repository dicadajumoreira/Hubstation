...
_PT_ACCENT_MAP: dict[str, str] = {
    ...
    "terceiro": "terceiro",
    "tres": "três",
    # Negação / verbo SER (não-ambíguos sem acento)
    "nao": "não",
    "sao": "são",
    "estao": "estão",
    # Substantivos -cao / -ção comuns em condomínio
    "reducao": "redução",
    "reducoes": "reduções",
    "decisao": "decisão",
    "decisoes": "decisões",
    ...
    "questao": "questão",
    "questoes": "questões",
    # Acentos em adjetivos / substantivos comuns
    "juridico": "jurídico",
    "juridica": "jurídica",
    "tecnico": "técnico",
    "tecnica": "técnica",
    ...
    # Específicos Consvicta / mercado condominial
    "boutique": "boutique",
    "balancete": "balancete",
    "auditoria": "auditoria",
    "previsao": "previsão",
